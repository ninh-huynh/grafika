...
package com.android.grafika.player
...
class MoviePlayerV2(
     ...
     *
     * @param mSourceFile The video file to open.
     * @param mOutputSurface The Surface where frames will be sent.
     * @param mFrameCallback Callback object, used to pace output.
     * @throws IOException
     */
    init {
        ...
        val parcelFileDescriptor = runCatching {
            ...
            .getOrNull() ?: throw RuntimeException("Can not get parcel file descriptor")
...
//        }
    ...
    class PlayTask(private val mPlayer: MoviePlayerV2, private val mFeedback: PlayerFeedback) :
         ...
         *
         * @param mPlayer The player object, configured with control and output.
